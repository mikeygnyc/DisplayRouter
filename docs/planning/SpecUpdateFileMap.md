...
- UI shell + layout: `admin/templates/index.html`, `admin/static/admin.css`
- UI logic/data fetch: `admin/static/admin.js`
...
- Likely new frontend build or framework integration under `admin/` (new files), plus updated `admin/main.py` to serve bundle/static assets.
- If SPA, replace `admin/templates/index.html` with SPA entry and add build artifacts under `admin/static/`.

**Payload type editor + dictionary/chooser inputs**
- Admin UI editor UI: `admin/static/admin.js`, `admin/templates/index.html`, `admin/static/admin.css`
...
- UI: `admin/static/admin.js`, `admin/static/admin.css`, `admin/templates/index.html`
...
- Admin UI embed: `admin/templates/index.html`, `admin/static/admin.js`

**Playground rework (smart editor + parameter pickers)**
- Playground UI: `display/sim_playground.py` (currently a basic HTML/JS blob)
- Possibly migrate playground into admin UI: `admin/templates/index.html`, `admin/static/admin.js`, `admin/static/admin.css`
...
- Admin UI: `admin/static/admin.js`, `admin/templates/index.html` to expose scratchpad UI
...
- Admin UI: `admin/static/admin.js`, `admin/templates/index.html`
...
- Admin UI: payload type editor and preview UI (`admin/static/admin.js`, `admin/templates/index.html`)
...
- Admin UI: `admin/static/admin.js` or playground integration
